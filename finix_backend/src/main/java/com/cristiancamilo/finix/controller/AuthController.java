...
import com.cristiancamilo.finix.dto.JwtResponseDTO;
import com.cristiancamilo.finix.dto.LoginRequestDTO;
import com.cristiancamilo.finix.jwt.JwtUtils;
import com.cristiancamilo.finix.service.UserDetailsImpl;
import com.cristiancamilo.finix.service.UserDetailsServiceImpl; // <-- Importación correcta
...
public class AuthController {
    ...
    @PostMapping("/login")
    public Mono<ResponseEntity<JwtResponseDTO>> authenticateUser(@RequestBody LoginRequestDTO loginDto) {

        return userDetailsService.findByUsername(loginDto.getUsername()) // <-- Uso el servicio correcto
                                .flatMap(userDetails -> {
